...
// ── Categories shown to the passenger ─────────────────────────────────
const CATEGORIES: { value: FeedbackCategory; label: string }[] = [
  { value: 'LOST_ITEM',      label: '🧳 Забравена вещ' },
  { value: 'DRIVER_FEEDBACK', label: '🚗 За шофьора' },
...
const styles = StyleSheet.create({
  ...
  linkBtnText: { color: ORANGE, fontWeight: '600', fontSize: 14 },
  linkedCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#fff',
  ...
  modalClose: { fontSize: 14, color: ORANGE, fontWeight: '600' },
